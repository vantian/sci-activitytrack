...
using Bkpm.ActivityTracker.Sessions;
using Bkpm.ActivityTracker.Web.Models.Account;
using Bkpm.ActivityTracker.Web.Views.Shared.Components.TenantChange;

namespace Bkpm.ActivityTracker.Web.Controllers
{
    public class AccountController : ActivityTrackerControllerBase
    {
